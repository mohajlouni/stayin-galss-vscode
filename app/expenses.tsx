...
export default function ExpensesScreen() {
  ...
  }, [expenses, language, selectedChaletId, settings.currency, period, customStart, customEnd, todayAnchor, weekAnchor, monthAnchor, searchQuery]);
