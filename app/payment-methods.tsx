...
type FloatDraft = { id?: string; entity: "staff" | "guard"; label: string; uid: string; phone: string; hasOther: boolean; otherNote: string; ceiling: string; isActive: boolean; isDefault: boolean; isCommissionEnabled: boolean; commissionType: "FIXED_PER_BOOKING" | "PERCENTAGE_OF_TOTAL"; commissionValue: string };
...
const emptyFloatDraft = (entity: "staff" | "guard"): FloatDraft => ({ entity, label: "", uid: "", phone: "", hasOther: false, otherNote: "", ceiling: "", isActive: false, isDefault: false, isCommissionEnabled: false, commissionType: "FIXED_PER_BOOKING", commissionValue: "" });
