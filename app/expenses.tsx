...
export default function ExpensesScreen() {
  ...
  const applyPeriodFilter = (id: "today" | "7" | "month" | "custom" | "all") => {
    ...
    if (id === "7") { setWeekAnchor(todayISO()); setStripCenter(todayISO()); }
    if (id === "month") { setMonthAnchor(todayISO().slice(0, 7)); setStripCenter(todayISO()); }
    if (id === "all") { setStripCenter(todayISO()); }
    setPeriod(id);
