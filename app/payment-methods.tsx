...
type FloatDraft = { id?: string; entity: "staff" | "guard"; onbookUid: string; label: string; uid: string; phone: string; hasOther: boolean; otherNote: string; ceiling: string; isActive: boolean; isDefault: boolean; isCommissionEnabled: boolean; commissionType: "FIXED_PER_BOOKING" | "PERCENTAGE_OF_TOTAL"; commissionValue: string };
type TeamEntry =
...
const emptyFloatDraft = (entity: "staff" | "guard"): FloatDraft => ({ entity, onbookUid: "", label: "", uid: "", phone: "", hasOther: false, otherNote: "", ceiling: "", isActive: false, isDefault: false, isCommissionEnabled: false, commissionType: "FIXED_PER_BOOKING", commissionValue: "" });
...
const missingIdLabel = () => language === "ar" ? "⚠️ بدون معرف" : "⚠️ No identifier";
  ...
  const teamOptions: TeamEntry[] = [
    ...
    ...selectableMembers.map((member): TeamEntry => ({ key: "member:" + member.userId, kind: "member", userId: member.userId, icon: "person", name: member.displayName, phone: member.phone ?? "", userCode: member.userCode, roleLabel: language === "ar" ? "عضو الفريق" : "Team member" })),
