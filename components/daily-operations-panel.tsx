...
export function DailyOperationsPanel({ arrivals, checkouts, outstanding, waitlist, onArrivalsPress, onCheckoutsPress, onOutstandingPress, onWaitlistPress, onTurnoverPress, showTurnoverAction = true, expanded, onToggleExpanded }: DailyOperationsPanelProps) {
