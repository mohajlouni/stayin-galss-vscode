...
const expenseSchema = z.object({
  ...
  amount: moneySchema,
  date: dateSchema,
  category: z.enum(["guards-salaries", "maintenance", "cleaning-supplies", "utilities", "other", "fuel-gas", "hospitality"]),
  note: optionalText,
