...
const settingsSchema = z.object({
  ...
  paymentRouting: z.object({ ownerAccounts: z.array(z.object({ id: z.string().regex(/^[a-z0-9-]{2,72}$/), kind: z.enum(["cliq", "bank", "vault"]), label: z.string().min(1).max(60), detail: z.string().max(200).optional(), provider: z.string().max(60).optional(), holderName: z.string().max(60).optional(), iban: z.string().max(200).optional(), isActive: z.boolean().optional(), isDefault: z.boolean().optional(), whatsApp: z.boolean().optional() })).optional(), masterAccounts: z.object({ cliqAlias: z.string().max(160).optional(), bankDetails: z.string().max(1000).optional(), cashHandlerLabel: z.string().max(120).optional(), directCliqEnabled: z.boolean().optional(), directBankEnabled: z.boolean().optional(), directCashEnabled: z.boolean().optional() }).optional(), staffFloats: z.array(z.object({ id: z.string().regex(/^[a-z0-9-]{2,72}$/), memberUserId: z.number().int().positive().optional(), memberName: z.string().max(120).optional(), contactPhone: z.string().max(30).optional(), label: z.string().min(1).max(120), cliqAlias: z.string().max(160).optional(), bankDetails: z.string().max(1000).optional(), channels: z.array(z.object({ kind: z.enum(["cliq", "bank"]), alias: z.string().max(160).optional(), provider: z.string().max(60).optional(), holderName: z.string().max(60).optional(), iban: z.string().max(200).optional(), isDefault: z.boolean().optional() })).optional(), maxFloatLimit: moneySchema.optional(), isActive: z.boolean().optional(), isDefault: z.boolean().optional(), whatsApp: z.boolean().optional(), entity: z.enum(["staff", "guard"]).optional() })).optional() }).optional(),
