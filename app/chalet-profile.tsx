...
export default function ChaletProfileScreen() {
  ...
  const save = async () => {
    ...
    const details = { name, propertyType, referenceCode: normalizedCode, color, imageUri, location, locationUrl, guardianName, guardianPhone, contactPhone, notes, weekendDays, shifts: normalizedShifts };
